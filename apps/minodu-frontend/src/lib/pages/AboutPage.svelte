	...
	{#if showPanel}
		...
		>
			...
			<div class="about-container content-width">
				...
				<div class="text">
					<p>
						Cette application a été développée dans le cadre du projet Minodu. Le code source
						complet est disponible en open source.
					</p>
					<p>
						Le projet Minodu est financé par le ministère fédéral allemand de la Recherche, de la
						Technologie et de l'Espace (BMFTR) dans le cadre de la ligne de financement « Gestion
						durable des terres en Afrique subsaharienne : améliorer les moyens de subsistance grâce
						à la recherche locale » (FKZ 01LL2202A)
					</p>
				</div>
				<div class="partners">
					<img src={dfkiLogo} />
